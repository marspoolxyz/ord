...
This requires [`ord`](https://github.com/marspoolxyz/ord), the ordinal utility. `ord`
...
[issues](https://github.com/marspoolxyz/ord/issues) and
[discussions](https://github.com/marspoolxyz/ord/discussions).
...
[source](https://github.com/marspoolxyz/ord). Pre-built binaries are available on the
[releases page](https://github.com/marspoolxyz/ord/releases).
